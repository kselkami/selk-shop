...
const Carousel = () => {
  ...
  return (
    <div className='p-[8px] rounded-lg bg-gradient-to-tr from-yellow-200 to-pink-500'>
        
        <div className='mx-auto w-[calc(100%)] max-h-[500px] overflow-hidden relative rounded-[5px]'>
            <div >
                ...
                <div className='absolute right-2 bottom-2 flex gap-4 z-20'>
                    <button onClick={prevSlide} className='p-2 px-4 lg:p-3 lg:px-6 border border-pink-500/30 bg-gray-800/30 rounded-lg'>
                    ...
                    <button onClick={nextSlide} className='p-2 px-4 lg:p-3 lg:px-6 border border-yellow-300/30 bg-gray-800/30 rounded-lg'>
