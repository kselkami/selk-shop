...
const Navbar = () => {
  ...
  return (
    <div className="wrapper py-4 px-6 w-full max-w-[1200px] mx-auto">
      ...
      <div onClick={toggleMenu} className={`navbar-backdrop fixed inset-0 bg-gray-800 opacity-80 z-100 ${toggle ? 'hidden' : ''}`}></div>
          ...
          <div className='lg:flex items-center gap-4'>
            ...
            <span className='flex gap-4'>
              ...
              <button className='relative flex'>
                ...
                <span className='flex justify-center items-center absolute -right-1 -top-1 p-1 bg-pink-500 text-white text-[10px] rounded-[50%] w-4 h-4'>0</span>
              </button>
            </span>
          </div>
        </div>
